...
% v2: 3/18/2015 - template for pages on RIGHT side
clear all; close all
...
p_greyTOP = patch([1 1 PaperW-Rmargin PaperW-Rmargin]./PaperW, ...
    [PaperH-Tmargin-dy Bmargin Bmargin PaperH-Tmargin-dy]./PaperH,[.5 .5 .5]);
...
p_greyTOP1 = patch([1 1 1+1/3 1+1/3]./PaperW, ...
    [PaperH-Tmargin+dy/2 Pos_Y_line(end)+dy/2 Pos_Y_line(end)+dy/2 PaperH-Tmargin+dy/2]./PaperH,[.5 .5 .5]);
set(p_greyTOP1,'edgecolor','none')
...
p_greyTOP2 = patch([7.5-4/3 7.5-4/3 7.5 7.5]./PaperW, ...
    [PaperH-Tmargin+dy/2 Pos_Y_line(end)+dy/2 Pos_Y_line(end)+dy/2 PaperH-Tmargin+dy/2]./PaperH,[.5 .5 .5]);
set(p_greyTOP2,'edgecolor','none')
...
text(0.5,(PaperH - dy*2.5)/PaperH,'ODD pages','horizontalalignment','center','fontsize',14)

%% print the page
print(hf_1,'-dpdf','-r600','test_2_R_grey')
