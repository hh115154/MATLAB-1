function [xi,yi,zi]=InterpolationGstat_SB2(x,y,z,res,radius,method,uselog,name,varargin)
...
%     yy=(min(y)-res):res:(max(y)+res);
    ...
    % hardwired to SF rainfall
    xx = 1.823284e6-res:res:1.834037e6+res;
    yy = 6.36076e5-res:res:6.46742e5+res;
