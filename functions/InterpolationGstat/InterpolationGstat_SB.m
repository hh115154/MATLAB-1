function [xi,yi,zi]=InterpolationGstat_SB(x,y,z,res,radius,method,uselog,name,varargin)
...
[s,w]=system('C:\Work\MATLAB\SSIP\InterpolationGstat\gstat.exe GstatInterp.cmd','-echo');
