function Jflow_figure_Scenario3_200yr_local_SB_normalized
...
print(hf_1,'-dpng',fullfile(ani_folder_loc,sprintf('Jflow_%s_200yr_normalized',sce_name)))
print(hf_1,'-dpdf',fullfile(ani_folder_loc,sprintf('Jflow_%s_200yr_normalized',sce_name)))
