function Jflow_figure_Scenario5_10yr_local
...
%                                  -------------------------------- whiskers    
    ...
    text(75,190000,{'Solid = Existing';'Dashed = Scenario'}, ...
...
print(hf_1,'-dpng',fullfile(ani_folder_loc,sprintf('Jflow_%s_10yr',sce_name)))
