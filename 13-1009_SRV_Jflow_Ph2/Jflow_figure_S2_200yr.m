function Jflow_figure_S2_200yr
...
tif_folder_S = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario2\200yr Upper\Upper200yrScenario2InterGrids.7z';
...
Figure_TITLE = 'Scenario 2 (Setbacks) - 200-year';
...
% ++++
flow_path_S = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario2\200yr Upper\Upper200yrScenario002MaxMonitors.7z';
...
% ++++
flow_path_SY = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario2\200yr Yolo\Yolo200yrScenario2MaxMonitor';
...
flow_file_Yolo11_12_S3 = 'YoloQ_Scenario2_200YR.csv';
...
feat_loc = 'R:\Projects\13-1009_JFLOW_Phase2\GIS\DM_GIS\Scenario2_Features_SB';
line_shp_1 = 'ID7_NL.shp';
line_shp_2 = 'ID8_NL_a.shp';
line_shp_3 = 'ID8_NL_b.shp';
line_shp_4 = 'ID11_NL.shp';
line_shp_5 = 'ID12_NL_a.shp';
line_shp_6 = 'ID12_NL_b.shp';
line_shp_7 = 'ID14_NL.shp';
line_shp_8 = 'ID22_NL.shp';
line_shp_9 = 'ID26R_NL.shp';



pgon_shp_1 = 'ID7_OL.shp';
pgon_shp_2 = 'ID8_OL_a.shp'; 
pgon_shp_3 = 'ID8_OL_b.shp';
pgon_shp_4 = 'ID11_OL.shp';
pgon_shp_5 = 'ID12_OL_a.shp'; 
pgon_shp_6 = 'ID12_OL_b.shp';
pgon_shp_7 = 'ID14_OL.shp';
pgon_shp_8 = 'ID14_OLb.shp'; 
pgon_shp_9 = 'ID22_OL.shp';
pgon_shp_10 = 'ID26R_OL.shp';
...
pn_y = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario2\200yr Yolo\Yolo200yrScenario2InterDepthGrids';
...
% 1st panel
draw_scenario_features(s1,feat_loc,line_shp_1);
draw_scenario_features(s1,feat_loc,line_shp_2);
draw_scenario_features(s1,feat_loc,line_shp_3);

draw_scenario_features(s1,feat_loc,pgon_shp_1);
draw_scenario_features(s1,feat_loc,pgon_shp_2);
draw_scenario_features(s1,feat_loc,pgon_shp_3);

% both panels
draw_scenario_features(s1,feat_loc,line_shp_4);
draw_scenario_features(s2,feat_loc,line_shp_4);
draw_scenario_features(s1,feat_loc,pgon_shp_4);
draw_scenario_features(s2,feat_loc,pgon_shp_4);

% 2nd panel
draw_scenario_features(s2,feat_loc,line_shp_5);
draw_scenario_features(s2,feat_loc,line_shp_6);
draw_scenario_features(s2,feat_loc,line_shp_7);
draw_scenario_features(s2,feat_loc,line_shp_8);
draw_scenario_features(s2,feat_loc,line_shp_9);

draw_scenario_features(s2,feat_loc,pgon_shp_5);
draw_scenario_features(s2,feat_loc,pgon_shp_6);
    ...
    switch S.Geometry
        ...
        case 'Polygon'
            ...
            for q = 1:length(S)
                ...
                % set(p1,'edgecolor','none')
                p1 = plot(ax_h,S(q).X(1:end-1).*factor,S(q).Y(1:end-1).*factor);
                set(p1,'linewidth',2,'color',[255 165 0]./255)
                hold(ax_h,'on')
            end
