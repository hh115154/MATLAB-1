function Jflow_figure_S4_200yr
...
tif_folder_S = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario4\Reruns6May14\UpperFeather200yrScenario004aInterGrids.7z';
...
Figure_TITLE = 'Scenario 4 (Sutter Widen) - 200-year';
...
% ++++
flow_path_S = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario4\Reruns6May14\UpperFeather200yrS004aMaxMonitors';
...
% ++++
flow_path_SY = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario4\YoloBypass\Yolo200yrScenario4MaxMonitors';
...
flow_file_Yolo11_12_S3 = 'YoloQ_Scenario4_200YR.csv';
...
feat_loc = 'R:\Projects\13-1009_JFLOW_Phase2\GIS\DM_GIS\Scenario4_Features_SB';
line_shp_1 = 'ID19_NL_a.shp';
line_shp_2 = 'ID19_NL_b.shp';

pgon_shp_1 = 'ID19_OL_a.shp';
pgon_shp_2 = 'ID19_OL_b.shp'; 
...
draw_scenario_features(s2,feat_loc,line_shp_2);
