function Jflow_figure_Scenario3_200yr_local_SB_normalized_v2
global color_Max image_name
close all

%% variables

tif_folder_S = 'C:\Work\13-1009_SRV_Jflow_Ph2\J_drive\Scenario3\Upper200yrScenario3InterDepthGrids.7z';
% tif_folder_S = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario3\Upper200yrScenario3InterDepthGrids.7z';

ani_folder_loc = 'C:\Work\13-1009_SRV_Jflow_Ph2\Animation_new';
...
% ------------- background image
image_name = 'C:\Work\13-1009_SRV_Jflow_Ph2\Input Data\Delta_map_600dpi_v3.jpg';
...
flow_file_Yolo11_12_S3 = 'YoloQ_Scenario3_200YR.csv';

% ------------- scenario features (shp file)
% feat_loc = 'R:\Projects\13-1009_JFLOW_Phase2\GIS\DM_GIS\Scenario3_Features_SB';
feat_loc = 'C:\Work\R_drive\Projects\13-1009_JFLOW_Phase2\GIS\DM_GIS\Scenario3_Features_SB';
...
set(s4,'xticklabel',[]);
title(s4,{'Scenario 3 (Storage) - 200-year';'Butte Basin'})
ylabel(s4,'Flow (cfs)')
grid(s4,'on')
