...
Figure_TITLE = 'Scenario 5 (Yolo Widen) - 10-year';
...
% ++++
flow_path_S = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\UpperandFeather10yrPhase1\UpperandFeather10yrMaxandMonitor';
...
% ++++
flow_path_SY = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario5\Yolo Only Simulations\Yolo10yrScenario5MaxMonitor';
...
flow_file_Yolo11_12_Ex = 'YoloQ_existing_10yr.csv';
flow_file_Yolo11_12_S3 = 'YoloQ_Scenario5_10YR.csv';
...
% vidObj = VideoWriter(fullfile(ani_folder_loc,sprintf('Jflow_%s_10yr.avi',sce_name)));
% vidObj.Quality = 100;
% vidObj.FrameRate = 4;
% open(vidObj);
...
pn_y = 'J:\M2_EdriveCopy\Work\13-1009_SRV_Jflow_Ph2\Scenario5\Yolo Only Simulations\Yolo10yrScenario5InterDepthGrids.7z';
...
%                                  -------------------------------- whiskers    
    ...
    text(80,190000,{'Solid = Existing';'Dashed = Scenario'}, ...
...
%     
    ...
    %% Snapshot at t = 300
%     if k == 100
%        grab_fn = fullfile(ani_folder_loc,sprintf('%s_10yr_%dhr',sce_name,round(t_hour(k))));
...
print(hf_1,'-dpng','-r300',fullfile(ani_folder_loc,sprintf('Jflow_%s_10yr_normalized',sce_name)))
print(hf_1,'-dpdf','-r300',fullfile(ani_folder_loc,sprintf('Jflow_%s_10yr_normalized',sce_name)))
