function Jflow_figure_Scenario3_200yr_local_SB_inches
...
for i = 1:6
    eval(sprintf('s%d=axes(''units'',''inches'',''position'',subplots(%d,:));',i,i))
end
...
print(hf_1,'-dpdf',fullfile(ani_folder_loc,sprintf('Jflow_%s_200yr_inches',sce_name)))
