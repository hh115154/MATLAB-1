function StormID = fun_storm_identification_v2(IN,RG)
...
StormIdAll(2,:) = datenum(RainT(indStormStart)) + (stormLength-1)*IN.RG.dt/60/24;
...
fidw = fopen(sprintf('Storm_ID_%s.txt',IN.RG.name(1:end-4)),'w');
