...
switch orientation
    case 'landscape'
        ...
        XData6=[13.69 13.69]./PaperW; YData6 = [ymarginB-Yoffset ymarginB-Yoffset+0.24]./PaperH;   % vertical lower right
    ...
    case 'portrait'
        XLogoLeft=[6-Yoffset-0.02 6-Yoffset-0.02]./PaperW; YLogo =[ymarginB-Yoffset 0.65+7/8-Yoffset]./PaperH;
        line(XLogoLeft,YLogo,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');
        
%         XLogoRight=[12.17 12.17]./PaperW;
        XLogoRight = XLogoLeft + 0.08;   % same width as Landscape window
        line(XLogoRight,YLogo,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');
        
        XData4=[XLogoRight(1) (PaperW-0.5)/PaperW]; YData4=[ymarginB-Yoffset+0.24 ymarginB-Yoffset+0.24]./PaperH;
        line(XData4,YData4,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');
        ...
        % vertical divider (TWO)
        
        XData6=[XLogoRight(1) XLogoRight(1)]+.11; YData6 = [ymarginB-Yoffset ymarginB-Yoffset+0.24]./PaperH;   % vertical lower right
        line(XData6,YData6,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');
        
        XData7=[XLogoRight(1) XLogoRight(1)]+.1*2;    % vertical lower right
        line(XData7,YData6,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');
