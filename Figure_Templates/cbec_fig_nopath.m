function [h_fig,h_axes]=cbec_fig_nopath(orientation,fig_text,subplots)
%CBEC_FIG_NOPATH Creates a PWA figure box and returns figure & axes handles. No file path will be specified
%
...
axes1 = axes('Parent',h_fig,...
    'Tag','FigureBox',...
    'Visible','on','units','inches','Position',[0.1 0.1 1 1]);
...
line(XData1,YData1,'Parent',h_fig,'Tag','Border','LineWidth',line_width,'Color','k');

% Create figure caption boxes
XData2=[0.05 0.95]; YData2=[0.14 0.14];
line(XData2,YData2,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');

XData3=[x_vert_bar-x_vert_offset x_vert_bar-x_vert_offset]; YData3=[0.05 0.14];
line(XData3,YData3,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');

XData3_1=[x_vert_bar+x_vert_offset x_vert_bar+x_vert_offset]; YData3_1=[0.05 0.14];
line(XData3_1,YData3_1,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');

XData4=[x_vert_bar+x_vert_offset 0.95]; YData4=[0.08 0.08];
...
XData6=[0.68 0.68]; YData6=[0.05 0.08];   % vertical lower right
line(XData6,YData6,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');

XData7=[0.82 0.82]; YData7=[0.05 0.08];   % vertical lower right
line(XData7,YData7,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');

% Create source text
h_text=text('Parent',axes1,'Tag','SourceText','Units','normalized',...
    'Position',[0.06 0.12],...
    'String',{['Notes:  ' fig_text.source]},...
...
text('Parent',axes1,'Tag','ProjectNumber','Units','normalized',...
    'Position',[(x_vert_bar+x_vert_offset+0.01) 0.07],...
...
text('Parent',axes1,'Tag','ProjectNumber','Units','normalized',...
    'Position',[(x_vert_bar+x_vert_offset+0.01+0.133) 0.07],...
