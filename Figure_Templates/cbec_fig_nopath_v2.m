function [h_fig,h_axes]=cbec_fig_nopath_v2(orientation,fig_text,subplots)
...
XLogoLeft=[0.5+4.43 0.5+4.43]./PaperW; YLogoLeft=[7/8-Yoffset 7/8-Yoffset+0.65]./PaperH;
line(XLogoLeft,YLogoLeft,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');

XLogoRight=[0.5+4.43+1.25 0.5+4.43+1.25]./PaperW; YLogoRight = [7/8-Yoffset 7/8-Yoffset+0.65]./PaperH;
line(XLogoRight,YLogoRight,'Parent',axes1,'Tag','Border','LineWidth',line_width,'Color','k');
