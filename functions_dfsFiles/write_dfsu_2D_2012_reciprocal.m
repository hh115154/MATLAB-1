...
NEW_filename = sprintf('%s_reciprocal.dfsu',orig_filename(1:end-5));
...
%     data_2(I) = 1./data(I);
    % Write to memory
    dfsu2.WriteItemTimeStep(converting_item,i,itemData.Time,NET.convertArray(single(data_2(:))));
end
% dfs2b.WriteItemTimeStep(1,0,Data.Time,NET.convertArray(single(z(:))));
