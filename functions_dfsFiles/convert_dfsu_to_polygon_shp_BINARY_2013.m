function convert_dfsu_to_polygon_shp_BINARY_2013(items,nsteps)
...
[tn_v, ~,~,~] = fun_CalcElementCenter_binary(Header.mesh_info);
...
shp_name = sprintf('%s_item%d.shp',filename(1:end-5),items);
