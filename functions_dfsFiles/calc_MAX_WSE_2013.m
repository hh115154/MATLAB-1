...
%     dfsu_path = 'C:\Work\12-1018_Arcade_Creek\Modeling\output\Ex';
%         'C:\Work\12-1018_Arcade_Creek\Modeling\output\Bridge';

        dfsu_path = 'C:\Work\13-1018_Ardenwood\Modeling\output\M21';
...
% dfsu_name = 'AC_2D_output_Ex_Q100.dfsu';
...
dfsu_name = 'Ardenwood_MF_Q100_ph2_Run3.dfsu';


%% *******************************************************   HEADER
%% 1. Open an output file (a placeholder)
% output_fn = sprintf('%s_Max_WSE_feet.dfsu',dfsu_name(1:end-5));
output_fn = sprintf('%s_Max_WSE.dfsu',dfsu_name(1:end-5));
