function convert_dfsu_to_polygon_shp_2012_v2(infile,items,nsteps)
...
% shp_name = sprintf('shp_Q25_Ex\\%s_%s_t_%d.shp',filename(1:end-5),item_name,nsteps);
shp_name = sprintf('%s_%s_t_%d.shp',filename(1:end-5),item_name,nsteps);
