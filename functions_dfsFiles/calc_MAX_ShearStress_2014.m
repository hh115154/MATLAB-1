...
%     dfsu_path = ...
%         'C:\Work\12-1018_Arcade_Creek\Modeling\output\Ex';
    dfsu_path = ...
...
% dfsu_name = 'AC_2D_output_Ex_Q100_shear.dfsu';
dfsu_name = 'AC_2D_output_Bridge_Q2_fix_shear.dfsu';
%% *******************************************************   HEADER
...
% i_shearstress = 5; % only one item available
