function Load_FLT_animation_Rev2(cfg)
close all
tic
...
- This script (Rev2) uses new arrangement that was used for snapshots.
  : different from [Load_FLT_animation_Alt1.m]
...
% load shape boundary
shp_p = '\\cbecm11\K\Raw Results\Aerial';
...
%%   
    ...
    if i == 1
        ...
        title(AX(1),sprintf('%s Modeled Flow Time Series',alt_type),'fontname',font_name,'fontsize',font_size)
