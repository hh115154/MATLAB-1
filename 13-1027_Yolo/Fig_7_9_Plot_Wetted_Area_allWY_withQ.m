function Fig_7_9_Plot_Wetted_Area_allWY_withQ(WY)
close all
% if isempty(nargin)
%     WY = 2007;
% end
...
lft_ax = 0.07;
bot_ax = 0.06;
subplots(2,1:4) = [lft_ax 0.65 .91 .3];
subplots(1,1:4) = [lft_ax bot_ax .91 .55];
...
grid(h_axes1(1),'on')
legend(h_axes1(1),{'Fremont Weir','Westside Tribs','Gate FreSm', ...
...
y1 = ylabel(h_axes1(1),'Flow (cfs)','fontsize',8);
y2 = ylabel(h_axes1(2),'Wetted Area (Acres)','fontsize',8);
...
fig_num = WY-1997;
print(h_fig,'-dpng',sprintf('Fig_A7-%d_Fremont_Q',fig_num))
% print(h_fig,'-dpdf','Fig_7-9_Fremont_Q')
