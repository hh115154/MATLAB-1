...
% cd('E:\Work\Projects\13-1027_Yolo_Bypass_Fish_Passage\LT Model\TUFLOW\results\2007\NearBypass\grids')
flt_path = pwd;

% cur_path = pwd;
% D = dir('*.mat');
D = dir('yolo*Exg*h*.flt');
tic
prev_time = 0;
...
mov(1:nFrames) = struct('cdata', [],...
                        'colormap', []);
vidObj = VideoWriter('yolo_200ft_Exg_2008_h_test.avi');
vidObj.Quality = 100;
vidObj.FrameRate = 4;
open(vidObj);
