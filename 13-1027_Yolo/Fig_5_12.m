...
label_y = interp1(D{1},maxd,label_st); 
%% plotting
...
D{3}(1:2) = NaN;  % intentionally removed due to instability in model
...
print_name = sprintf('Fig_5-12_r300_test_%s_%s',figure_type,orientation);
